...
r   Key([mod, "shift"], "q", lazy.shutdown(), desc="Shutdown Qtile"),
    Key([mod], "r", lazy.spawn(dmenu_run -fn 'FiraCode Nerd Font-14' -nb '#111111' -nf '#11ccff'), desc="Spawn a command using a prompt widget"),
]
